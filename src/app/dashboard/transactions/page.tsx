...
const UserTransactionsPage = () => {
  // TODO: Fetch transactions for the currently logged-in user
  const userTransactions: Transaction[] = [...transactions].sort((a, b) => new Date(b.date).getTime() - new Date(a.date).getTime());
